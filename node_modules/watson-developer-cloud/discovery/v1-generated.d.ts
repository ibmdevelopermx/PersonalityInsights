...
declare namespace DiscoveryV1 {
    ...
    interface ElementsEnrichmentOptions {
    ...
    interface LanguageEnrichmentOptions {
    ...
    interface NluEnrichmentOptions {
        /** An object representing the enrichment features that will be applied to the specified field. */
        features?: NluEnrichmentFeatures;
    }
    /** An object specifying the relations enrichment and related parameters. */
    ...
    interface TrainingExamplePatch {
        cross_reference?: string;
        relevance?: number;
    }
    /** TrainingQuery. */
